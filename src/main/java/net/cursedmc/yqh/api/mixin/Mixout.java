...
//		Music.retransformClass(
//			Music.class.getClassLoader().loadClass("org.spongepowered.asm.mixin.transformer.MixinTransformer"),
//			(name, cn) -> {
//				for (MethodNode m : cn.methods) {
//					if ("(Lorg/spongepowered/asm/mixin/MixinEnvironment;Ljava/lang/String;[B)[B".equals(m.desc)) {
//						LOGGER.info( "Target method found: {}", m.name );
